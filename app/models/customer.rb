class Customer < ApplicationRecord
  ...
  def create_ordered_meals
    ...
    meals.each do |meal|
      order_meal = self.ordered_meals.new(meal_id: meal.id, ideal_served_time: next_serve_time, is_started: false, is_rescheduled: false, actual_velocity_params: self.add_actual_velocity_params)
      order_meal.save
